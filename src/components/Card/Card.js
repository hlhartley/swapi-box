...
class Card extends Component {
    ...
    renderCards = () => {
        ...
        if(this.props.selected === 'planets') {
            return <p className='card-body'>Terrain: {this.props.property.terrain}<br />Population: {this.props.property.population}<br />Climate: {this.props.property.climate}<br />Residents: {this.props.property.language}</p>
        }
